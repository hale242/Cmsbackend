                                    ...
                                    <div class="card-body">
                                        <div class="form-horizontal form-upload">
                                            ...
                                            <div class="form-group row pb-3">
                                                <label for="add_event_details_subject" class="col-sm-3 text-right control-label col-form-label">Event Subject</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="add_event_details_subject" name="lang[{{$val->languages_id}}][event_details_subject]" required>
                                                </div>
                                            </div>
                                            <div class="form-group row pb-3">
                                            ...
                                            <div class="form-group row pb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="editor"  id="add_event_details_description_{{$val->languages_id}}" data-sample="3" data-sample-short name="lang[{{$val->languages_id}}][event_details_description]"></textarea>
                                ...
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="form-horizontal form-upload">
                                            <input type="hidden" id="add_languages_id" name="lang[{{$val->languages_id}}][languages_id]" value="{{ $val->languages_id }}">
                                            <div class="form-group row pb-3">
                                                <label for="edit_event_details_subject" class="col-sm-3 text-right control-label col-form-label">Event Subject</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="edit_event_details_subject_{{$val->languages_id}}" name="lang[{{$val->languages_id}}][event_details_subject]" required>
                                                </div>
                                            </div>
                                            <div class="form-group row pb-3">
                                            ...
                                            <div class="form-group row pb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="editor-edit" cols="60" id="edit_event_details_description_{{$val->languages_id}}" rows="6" data-sample="3" data-sample-short name="lang[{{$val->languages_id}}][event_details_description]"></textarea>
    ...
    $('body').on('click', '.btn-edit', function(data) {
        ...
        $.ajax({
            ...
            $.each(data.event_detail, function(k, v) {
                ...
                $('#edit_event_details_subject_' + v.languages_id).val(v.event_details_subject);
                ...
                $('#edit_event_details_description_' + v.languages_id).val(v.event_details_description);
