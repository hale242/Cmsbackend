                    ...
                    <div class="row pt-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="search_news_category_seo_title" class="form-control search_table">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Keyword</label>
                                <input type="text" id="search_news_category_seo_keyword" class="form-control search_table">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Description</label>
                                <input type="text" id="search_news_category_seo_description" class="form-control search_table">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Url Slug</label>
                                <input type="text" id="search_news_category_url_slug" class="form-control search_table">
                            </div>
                        </div>
                    </div>
                </form>
